...
fun MovieDetailScreen(
    ...
    val movieDto by viewModel.uiMovieDto.collectAsState()
...
private fun MovieDetailPreview() {
    CineNowTheme {
        val movie = MovieDto(
            ...
            title = "Title",
            postPath = "2304",
            overview = "long overview movie,long overview movie,long overview movie,long overview movie,long overview movie"
        )
