            ...
            CineNowTheme {
                ...
                callUpcoming.enqueue(object : Callback<MovieResponse> {
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            Log.d("MainActivity", "Resquest error: ${response.errorBody()}")
                        }
                    }
                ...
                Surface(
                    ...
                    Column(
                        ...
                        MovieSession(
                            label = "Now playing", nowPlayingMovies
                        ) { movieClicked ->
...
@Composable
fun MovieSession(label: String, movieList: List<MovieDto>, onClick: (MovieDto) -> Unit) {
